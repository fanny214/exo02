...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'fanny_exo02_76984f16bbd8d0c24597_20220311111147_archive.zip';
	const ARCHIVE_SIZE		 = '77538073';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '76984f1-11111147';
    const SECONDARY_PACKAGE_HASH = '600be28-11111147';
	const VERSION			 = '1.4.4';
